...
### Use of each file
```
list/ArrayList  list implementation featuring a resizable array
list/LinkedList list implementation featuring nodes with a pointer to the next element in the array
map/ArrayMap  map implementation featuring an array of key value pairs
map/HashMap map implementation featuring a hash table of key value pairs
