...
public class WeightedListGraph<T,W> extends WeightedGraph<T,W> {
  private ArrayList<GraphNode<T,W>> V;
  public WeightedListGraph(){
    this(10,false);
  }
  public WeightedListGraph(int s){
    this(s,false);
  }
  public WeightedListGraph(boolean d){
    this(10,d);
  }
  public WeightedListGraph(int s, boolean d){
